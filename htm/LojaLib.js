...
var sF$=(function(){
  ...
  function fnLoginUserName(NameUser,PicUser){
    ...
    if(NameUser==""){
      jQuery('.loginInfo').html("<span><a href='/cadastro.asp?idloja="+FC$.IDLoja+"&pp=3&passo=1&sit=1'>Clique e Faça seu Login</a></span>");
    ...
    if(oFoto){
      if(PicUser==undefined || PicUser==""){oFoto.src=FC$.PathImg+"man-user.svg";}
...
function fnFooter(){
  ...
  if (FC$.Page=="Products" && ListVerify){
    document.querySelector('#idFCContent').setAttribute('class','col-small-12 col-medium-9 col-large-9 col-mlarge-9 col-xlarge-10 listProd');
  };
